...
public class HelloWorld {
	...
	@RequestMapping(value ="/helloString/{helloID}", method = RequestMethod.GET, params= "myCity=Hyd")
	...
	// Handles helloworld/sayspringbatch
		...
		public String morning(Model model) {
			model.addAttribute("message6","Good morning! ");
			return "myPage6";
		}
		
		@RequestMapping(value ="/evening", method = RequestMethod.GET)
		public String evening(Model model) {
			model.addAttribute("message1","Good evening! ");
			return "myPage1";
		}
		
		@RequestMapping(value ="/afternoon", method = RequestMethod.GET)
		public String afternoon(Model model) {
			model.addAttribute("message6","Good afternoon! ");
			return "myPage6";
		}
